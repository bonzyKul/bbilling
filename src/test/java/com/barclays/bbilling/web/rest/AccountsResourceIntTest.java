...
private static final AccountStatus DEFAULT_ACCOUNT_STATUS = AccountStatus.ACTIVE;
    ...
    private static final BigDecimal DEFAULT_ACCOUNT_CRTURN_OVER = new BigDecimal(1);
    private static final BigDecimal UPDATED_ACCOUNT_CRTURN_OVER = new BigDecimal(2);
...
private static final AccountTier DEFAULT_ACCOUNT_TIER = AccountTier.TIER0;
    ...
    @Test
    @Transactional
    public void checkAccountDRTurnOverIsRequired() throws Exception {
        int databaseSizeBeforeTest = accountsRepository.findAll().size();
        // set the field null
        accounts.setAccountDRTurnOver(null);
