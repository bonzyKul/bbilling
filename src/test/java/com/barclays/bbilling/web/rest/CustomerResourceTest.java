...
private static final CustomerType DEFAULT_CUSTOMER_TYPE = CustomerType.STAFF;
    ...
    private static final String DEFAULT_CUSTOMER_EMAIL = "A";
    private static final String UPDATED_CUSTOMER_EMAIL = "B";

    private static final String DEFAULT_CUSTOMER_TEL_NO = "1";
    private static final String UPDATED_CUSTOMER_TEL_NO = "2";

    private static final String DEFAULT_CUSTOMER_MOBILE_NO = "1";
    private static final String UPDATED_CUSTOMER_MOBILE_NO = "2";
