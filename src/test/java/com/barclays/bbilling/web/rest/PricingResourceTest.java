...
private static final PricingRateType DEFAULT_PRICING_RATE_TYPE = PricingRateType.FLAT;
    ...
    private static final Integer DEFAULT_PRICING_TIER_FROM = 1;
    private static final Integer UPDATED_PRICING_TIER_FROM = 2;

    private static final Integer DEFAULT_PRICING_TIER_TO = 1;
    private static final Integer UPDATED_PRICING_TIER_TO = 2;
...
private static final PricingAmountType DEFAULT_PRICING_AMOUNT_TYPE = PricingAmountType.CR;
    ...
    public void getAllPricings() throws Exception {
        ...
        restPricingMockMvc.perform(get("/api/pricings"))
                ...
                .andExpect(jsonPath("$.[*].pricingTierFrom").value(hasItem(DEFAULT_PRICING_TIER_FROM)))
                .andExpect(jsonPath("$.[*].pricingTierTo").value(hasItem(DEFAULT_PRICING_TIER_TO)))
    ...
    public void getPricing() throws Exception {
        ...
        restPricingMockMvc.perform(get("/api/pricings/{id}", pricing.getId()))
            ...
            .andExpect(jsonPath("$.pricingTierFrom").value(DEFAULT_PRICING_TIER_FROM))
            .andExpect(jsonPath("$.pricingTierTo").value(DEFAULT_PRICING_TIER_TO))
